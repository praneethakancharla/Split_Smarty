...
CREATE TABLE `split` (
  ...
  `share_expense` int DEFAULT NULL,
  ...
  KEY `from_id` (`from_id`),
  KEY `to_id` (`to_id`),
  CONSTRAINT `split_ibfk_1` FOREIGN KEY (`expense_id`) REFERENCES `group_expenses` (`expense_id`),
  CONSTRAINT `split_ibfk_2` FOREIGN KEY (`from_id`) REFERENCES `user` (`user_id`),
  CONSTRAINT `split_ibfk_3` FOREIGN KEY (`to_id`) REFERENCES `user` (`user_id`)
